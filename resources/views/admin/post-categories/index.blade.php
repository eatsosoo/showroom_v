...
@section('content')
    <x-common.page-breadcrumb pageTitle="Danh mục bài viết" />
    @include('admin.partials.flash')

    <x-common.component-card title="Danh mục bài viết">
        <div class="mb-4 flex justify-end">
            <a href="{{ route('admin.post-categories.create') }}" class="rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white">Thêm danh mục</a>
        </div>
